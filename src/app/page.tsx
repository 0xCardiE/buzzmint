  ...
  return (
    <div className="buzz-theme">
      ...
      <main className="buzz-container">
        ...
        >
          <div className="buzz-powered-by">
            <span className="buzz-powered-by-text">Powered by</span>
            <div className="buzz-powered-by-logos">
              <a
                href="https://www.ethswarm.org/"
                target="_blank"
                rel="noopener noreferrer"
                className="buzz-powered-by-link"
              >
                <img src="/swarm-logo.png" alt="Ethereum Swarm" className="buzz-powered-by-logo" />
                <span>Ethereum Swarm</span>
              </a>
              ...
              <a
                ...
                className="buzz-powered-by-link"
              >
                <img src="/lifi-logo.png" alt="Li.Fi" className="buzz-powered-by-logo" />
                <span>Li.Fi</span>
              </a>
              ...
              <a
                ...
                className="buzz-powered-by-link"
              >
                <div className="buzz-openai-logo">
